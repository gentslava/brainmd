...
- Периодические разборы (ОПиУ/мес, воронка/конверсия/мес, дневные/недельные продажи) оформлять паттерном **индекс-реестр (`type: moc`) → листы `YYYY-MM`**: листы одного ряда не ссылаются друг на друга, кросс-периодные сравнения — в индексе. Канон — [[SCHEMA]] §10.1–10.4.
